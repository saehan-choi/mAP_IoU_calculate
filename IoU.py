...
def intersection_over_union(boxes_preds, boxes_labels, box_format="corners"):
    ...
    # if (intersection / (box1_area + box2_area - intersection))>1:
    #     print(f'box1     : {box1_x1} {box1_y1} {box1_x2} {box1_y2}')
    #     print(f'box2     : {box2_x1} {box2_y1} {box2_x2} {box2_x2}')
    #     print(f'interbox : {x1} {y1} {x2} {y2}')
